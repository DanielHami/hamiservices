...
const Modal = props => {
    return (
        <>
            ...
            <div className="modal fade fixed top-0 left-0 hidden w-full h-fit outline-none overflow-x-hidden overflow-y-auto"
                ...
                <div className="modal-dialog modal-fullscreen relative w-auto pointer-events-none">
                    <div
                        ...
                        <div
                            className="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t gap-4 border-gray-200 rounded-b-md">
                             <button 
